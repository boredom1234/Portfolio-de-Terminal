...
<!-- Blog Post: https://boredom1234.dev/blog/posts/how-do-i-develop-my-terminal-portfolio-website-with-react -->
...
<p align="center">
<img width="710" alt="boredom1234 Terminal Lighthouse Score" src="public/lighthouse-result.svg">
</p>
...
```bash
git clone https://github.com/boredom1234/terminal-portfolio.git
```
...
- [@boredom1234](https://boredom1234.dev)
